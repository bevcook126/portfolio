...
export default function Resume() {
    return (
        ...
        <div className="cards">
            ...
            <div className="resume-card">
              <h2>K/TK Teacher - Kids N' Dance N' Theater Arts, Oakland CA</h2>
                <ul>
            ...
            <div className="resume-card">
                <h2>K/1 Teacher - Rocketship Public Schools, Concord CA</h2>
                <ul>
            ...
            <div className="resume-card">
                <h2>Teacher/Site Supervisor - Child Development Resource Center, San Luis Obispo CA</h2>
                <ul>
